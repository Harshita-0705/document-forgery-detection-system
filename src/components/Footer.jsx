        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold text-white">DFS</span>
            </div>
            <p className="text-sm">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-white transition-colors">API Docs (Coming Soon)</a></li>
          ...
          <div>
            ...
            <p className="text-sm mb-4">Stay updated with fraud detection trends</p>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400 mb-4 md:mb-0">
              © {new Date().getFullYear()} Document Forgery Detection System. All rights reserved.
            </p>
